      ...
      <div class="bg-blue-600 p-8 md:p-12 lg:px-16 lg:py-24">
        <div class="mx-auto max-w-xl text-center">
          <h2 class="text-2xl font-bold text-white md:text-3xl">
            At NITAI Solutions, we are committed to providing excellent services to our customers and clients 
          </h2>

          <p class="hidden text-white/90 sm:mt-4 sm:block">
            We believe that we can make a positive impact on our community, industry, and the world. Our Lando team is dedicated to providing the best possible service and support, and we are always looking for ways to improve and innovate.
...
<section class="bg-white lg:grid lg:h-screen  dark:bg-gray-900">
  <div class="mx-auto w-screen max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
    <div class="mx-auto max-w-prose">
     
        <h2 class="text-3xl font-bold tracking-tight text-gray-900 dark:text-white  text-center sm:text-4xl items-left">
        NITAI Solutions Pvt. Ltd
        </h2>
        <p class="mt-4 text-lg leading-8 text-gray-600 dark:text-gray-400 text-center">
        NITAI Solutions Pvt Ltd is a forward-thinking recruitment consultancy dedicated to bridging the gap between talent and opportunity. Specializing in connecting skilled professionals with leading companies, we provide tailored recruitment solutions across diverse industries.
        </p>
        <p class="mt-4 text-lg leading-8 text-gray-600 dark:text-gray-400 text-center">
        Our mission is to empower organizations by delivering top-tier talent that drives success and innovation. With a commitment to excellence, we leverage our industry expertise and extensive network to ensure a seamless recruitment experience for both candidates and clients.
        </p>
        <p class="mt-4 text-lg leading-8 text-gray-600 dark:text-gray-400 text-center">
        At NITAI Solutions, we understand that every organization is unique. That's why we take the time to understand your specific needs and culture, allowing us to find candidates who not only possess the right skills but also align with your values and vision.
        </p>
        <p class="mt-4 text-lg leading-8 text-gray-600 dark:text-gray-400 text-center">
        Our team of experienced recruiters is dedicated to providing personalized service, ensuring that we are with you every step of the way. From initial consultation to candidate placement, we are committed to delivering results that exceed your expectations.
        </p>
